         ...
         <div class="form"> 
          ...
          <form> {/* starting form list*/}
            ...
            <div id="birthday-gender"> {/* BDAY & GENDER */}
              ...
              <input type="radio" id="female" value=""/> <label for="Female">Female</label>
              <input type="radio" id="male" value=""/> <label for="male">Male</label>
            </div>
            
            <div>
              <label for="grade">Grade:</label> {/* GRADE */}
              <input type="radio" id="Pre-School" value=""/> <label for="male">Pre-School</label>
              <input type="radio" id="grade-one" value=""/> <label for="male">1st</label>
              <input type="radio" id="grade-two" value=""/> <label for="male">2nd</label>
              <input type="radio" id="grade-three" value=""/> <label for="male">3rd</label>
              <input type="radio" id="grade-four" value=""/> <label for="male">4th</label>
              <input type="radio" id="grade-five" value=""/> <label for="male">5th</label>

            </div>

            <div>  {/* PARENT/GUARDIAN */}
            <label for="parent-garden">Parent/Guardian: </label><input class="parent-garden" type="parent" id="parent" name="parent" value="" />
            </div>
            ...
            <label for="contact-email">Contact Email: </label><input class="players-details" type="contact" id="contact" name="contact" value="" />
              ...
              <div>  {/* TABLE WITH POSITION PLAYER */}
               Which position(s) do you normally play?
